...
Run: pytest custom_demo/tests/test_hallucination_bug.py -v
"""
...
import custom_demo.runtime.agent as agent_mod
from custom_demo.config import load_env, sandbox_enabled
from custom_demo.runtime.prompt import _FALLBACK_CORE, FALLBACK_PROMPT, HALLUCINATION_CLAUSE

...
to LangSmith, set LANGSMITH_TEST_TRACKING=false.
    ...
    ANTHROPIC_API_KEY=... CTXHUB_TEST_WORKSPACE=<workspace-id> \\
      ...
      uv run pytest custom_demo/tests/test_contexthub_skill.py --langsmith-output
"""
...
from custom_demo.provisioning.setup import (
    _SKILLS_CLAUSE,
    _ws_client,
    push_agent_prompt,
...
from custom_demo.runtime.prompt import build_system_prompt
